...
public class ClassProcessTypeMap {
    ...
    public static List<String> getBusinessProcessIds() {
        return Arrays.asList(CAMUNDA_PROCESS_ID_ITEM_INFORMATION_REQUEST, CAMUNDA_PROCESS_ID_PPAP, CAMUNDA_PROCESS_ID_NEGOTIATION, CAMUNDA_PROCESS_ID_ORDER, CAMUNDA_PROCESS_ID_FULFILMENT, CAMUNDA_PROCESS_ID_TRANSPORT_EXECUTION_PLAN);
    }
}