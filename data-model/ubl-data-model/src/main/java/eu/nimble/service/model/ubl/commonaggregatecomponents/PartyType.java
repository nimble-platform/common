...
// Generated on: 2021.03.01 at 04:52:24 PM EET 
//
    ...
    implements Serializable, Equals
{
    ...
    @JoinColumn(name = "METADATA_PARTY_TYPE_HJID")
     ...
     * 
     */
    @OneToMany(orphanRemoval = true,targetEntity = NetworkType.class, cascade = {
        javax.persistence.CascadeType.ALL
    })
    @JoinColumn(name = "NETWORK_PARTY_TYPE_HJID")
     ...
     *     
     */
    @OneToOne(orphanRemoval = true,targetEntity = TextType.class, cascade = {
        javax.persistence.CascadeType.ALL
    })
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            List<NetworkType> lhsNetwork;
            lhsNetwork = (((this.network!= null)&&(!this.network.isEmpty()))?this.getNetwork():null);
            List<NetworkType> rhsNetwork;
            rhsNetwork = (((that.network!= null)&&(!that.network.isEmpty()))?that.getNetwork():null);
