    ...
    implements Serializable, Equals
{
    ...
    protected Long hjid;
    protected transient List<CapabilityTypeDescriptionItem> descriptionItems;
    ...
    @OneToMany(orphanRemoval = true, targetEntity = CapabilityTypeDescriptionItem.class, cascade = {
        javax.persistence.CascadeType.ALL
    })
    @JoinColumn(name = "DESCRIPTION_ITEMS_CAPABILITY_0")
    public List<CapabilityTypeDescriptionItem> getDescriptionItems() {
        if (this.descriptionItems == null) {
            this.descriptionItems = new ArrayList<CapabilityTypeDescriptionItem>();
        }
        if (ItemUtils.shouldBeWrapped(this.description)) {
            this.description = ItemUtils.wrap(this.description, this.descriptionItems, CapabilityTypeDescriptionItem.class);
        }
        return this.descriptionItems;
    }

    public void setDescriptionItems(List<CapabilityTypeDescriptionItem> value) {
