 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2}NonPublicInformation" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2}ProductStatusType"/&gt;
    ...
    implements Serializable, Equals
{
    ...
    @XmlElement(name = "NonPublicInformation")
    protected List<NonPublicInformationType> nonPublicInformation;
    @XmlElement(name = "ProductStatusType", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2", required = true)
    ...
    /**
     * Gets the value of the nonPublicInformation property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the nonPublicInformation property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNonPublicInformation().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link NonPublicInformationType }
     * 
     * 
     */
    @OneToMany(orphanRemoval = true,targetEntity = NonPublicInformationType.class, cascade = {
        javax.persistence.CascadeType.ALL
    })
    @JoinColumn(name = "NON_PUBLIC_INFORMATION_CATAL_0")
    public List<NonPublicInformationType> getNonPublicInformation() {
        if (nonPublicInformation == null) {
            nonPublicInformation = new ArrayList<NonPublicInformationType>();
        }
        return this.nonPublicInformation;
    }
     ...
     * 
     */
    public void setNonPublicInformation(List<NonPublicInformationType> nonPublicInformation) {
        this.nonPublicInformation = nonPublicInformation;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            List<NonPublicInformationType> lhsNonPublicInformation;
            lhsNonPublicInformation = (((this.nonPublicInformation!= null)&&(!this.nonPublicInformation.isEmpty()))?this.getNonPublicInformation():null);
            List<NonPublicInformationType> rhsNonPublicInformation;
            rhsNonPublicInformation = (((that.nonPublicInformation!= null)&&(!that.nonPublicInformation.isEmpty()))?that.getNonPublicInformation():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "nonPublicInformation", lhsNonPublicInformation), LocatorUtils.property(thatLocator, "nonPublicInformation", rhsNonPublicInformation), lhsNonPublicInformation, rhsNonPublicInformation)) {
                return false;
            }
        }
        {
            String lhsProductStatusType;
            lhsProductStatusType = this.getProductStatusType();
            String rhsProductStatusType;
            rhsProductStatusType = that.getProductStatusType();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "productStatusType", lhsProductStatusType), LocatorUtils.property(thatLocator, "productStatusType", rhsProductStatusType), lhsProductStatusType, rhsProductStatusType)) {
                return false;
            }
        }
        {
