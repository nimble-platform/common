    ...
    implements Serializable, Equals
{
     ...
     */
    @Basic
    @Column(name = "HANDLING_INSTRUCTIONS", length = 255)
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            String lhsHandlingInstructions;
            lhsHandlingInstructions = this.getHandlingInstructions();
            String rhsHandlingInstructions;
            rhsHandlingInstructions = that.getHandlingInstructions();
