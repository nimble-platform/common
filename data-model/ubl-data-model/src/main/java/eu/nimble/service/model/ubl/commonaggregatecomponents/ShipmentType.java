...
// Generated on: 2020.03.10 at 02:28:39 PM EET 
//
    ...
    implements Serializable, Equals
{
    ...
    protected Long hjid;
    protected transient List<ShipmentTypeSpecialInstructionsItem> specialInstructionsItems;
    ...
    public List<String> getSpecialInstructions() {
        if (specialInstructions == null) {
            specialInstructions = new ArrayList<String>();
        }
    ...
    @JoinColumn(name = "ADDITIONAL_DOCUMENT_REFERENC_10")
    ...
    @OneToMany(orphanRemoval = true, targetEntity = ShipmentTypeSpecialInstructionsItem.class, cascade = {
        javax.persistence.CascadeType.ALL
    })
    @JoinColumn(name = "SPECIAL_INSTRUCTIONS_ITEMS_S_0")
    public List<ShipmentTypeSpecialInstructionsItem> getSpecialInstructionsItems() {
        if (this.specialInstructionsItems == null) {
            this.specialInstructionsItems = new ArrayList<ShipmentTypeSpecialInstructionsItem>();
        }
        if (ItemUtils.shouldBeWrapped(this.specialInstructions)) {
            this.specialInstructions = ItemUtils.wrap(this.specialInstructions, this.specialInstructionsItems, ShipmentTypeSpecialInstructionsItem.class);
        }
        return this.specialInstructionsItems;
    }

    public void setSpecialInstructionsItems(List<ShipmentTypeSpecialInstructionsItem> value) {
        this.specialInstructions = null;
        this.specialInstructionsItems = null;
        this.specialInstructionsItems = value;
        if (this.specialInstructionsItems == null) {
            this.specialInstructionsItems = new ArrayList<ShipmentTypeSpecialInstructionsItem>();
        }
        if (ItemUtils.shouldBeWrapped(this.specialInstructions)) {
