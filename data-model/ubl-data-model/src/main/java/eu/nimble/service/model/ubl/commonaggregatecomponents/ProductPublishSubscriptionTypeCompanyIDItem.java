...
@Entity(name = "ProductPublishSubscriptionTypeCompanyIDItem")
@Table(name = "PRODUCT_PUBLISH_SUBSCRIPTION_2")
@Inheritance(strategy = InheritanceType.JOINED)
public class ProductPublishSubscriptionTypeCompanyIDItem
