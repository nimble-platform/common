    ...
    implements Serializable, Equals
{
    ...
    protected List<TextType> roleDescription;
    ...
    @JoinColumn(name = "ROLE_DESCRIPTION_ECONOMIC_OP_0")
    public List<TextType> getRoleDescription() {
        if (roleDescription == null) {
            roleDescription = new ArrayList<TextType>();
        }
     ...
     * 
     */
    public void setRoleDescription(List<TextType> roleDescription) {
