    ...
    implements Serializable, Equals
{
    ...
    protected Long hjid;
    protected transient List<CompletedTaskTypeDescriptionItem> descriptionItems;
    ...
    @OneToMany(orphanRemoval = true, targetEntity = CompletedTaskTypeDescriptionItem.class, cascade = {
        javax.persistence.CascadeType.ALL
    })
    @JoinColumn(name = "DESCRIPTION_ITEMS_COMPLETED__0")
    public List<CompletedTaskTypeDescriptionItem> getDescriptionItems() {
        if (this.descriptionItems == null) {
            this.descriptionItems = new ArrayList<CompletedTaskTypeDescriptionItem>();
        }
        if (ItemUtils.shouldBeWrapped(this.description)) {
            this.description = ItemUtils.wrap(this.description, this.descriptionItems, CompletedTaskTypeDescriptionItem.class);
        }
        return this.descriptionItems;
    }

    public void setDescriptionItems(List<CompletedTaskTypeDescriptionItem> value) {
