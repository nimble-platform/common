 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2}ClauseTitle" maxOccurs="unbounded" minOccurs="0"/&gt;
    ...
    implements Serializable, Equals
{
    ...
    @XmlElement(name = "ClauseTitle", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")
    protected List<TextType> clauseTitle;
    ...
    /**
     * Gets the value of the clauseTitle property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the clauseTitle property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getClauseTitle().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    @JoinColumn(name = "CLAUSE_TITLE_CLAUSE_TYPE_HJID")
    public List<TextType> getClauseTitle() {
        if (clauseTitle == null) {
            clauseTitle = new ArrayList<TextType>();
        }
     ...
     * 
     */
    public void setClauseTitle(List<TextType> clauseTitle) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            List<TextType> lhsClauseTitle;
            lhsClauseTitle = (((this.clauseTitle!= null)&&(!this.clauseTitle.isEmpty()))?this.getClauseTitle():null);
            List<TextType> rhsClauseTitle;
            rhsClauseTitle = (((that.clauseTitle!= null)&&(!that.clauseTitle.isEmpty()))?that.getClauseTitle():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "clauseTitle", lhsClauseTitle), LocatorUtils.property(thatLocator, "clauseTitle", rhsClauseTitle), lhsClauseTitle, rhsClauseTitle)) {
                return false;
            }
        }
        {
