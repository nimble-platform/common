 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2}LifeCycleDetails" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable, Equals
{
    ...
    @XmlElement(name = "LifeCycleDetails")
    protected LifeCycleDetailsType lifeCycleDetails;
    ...
    /**
     * Gets the value of the lifeCycleDetails property.
     * 
     * @return
     *     possible object is
     *     {@link LifeCycleDetailsType }
     *     
     */
    @ManyToOne(targetEntity = LifeCycleDetailsType.class, cascade = {
        javax.persistence.CascadeType.ALL
    })
    @JoinColumn(name = "LIFE_CYCLE_DETAILS_ITEM_TYPE_0")
    public LifeCycleDetailsType getLifeCycleDetails() {
        return lifeCycleDetails;
    }

    /**
     * Sets the value of the lifeCycleDetails property.
     * 
     * @param value
     *     allowed object is
     *     {@link LifeCycleDetailsType }
     *     
     */
    public void setLifeCycleDetails(LifeCycleDetailsType value) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            LifeCycleDetailsType lhsLifeCycleDetails;
            lhsLifeCycleDetails = this.getLifeCycleDetails();
            LifeCycleDetailsType rhsLifeCycleDetails;
            rhsLifeCycleDetails = that.getLifeCycleDetails();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "lifeCycleDetails", lhsLifeCycleDetails), LocatorUtils.property(thatLocator, "lifeCycleDetails", rhsLifeCycleDetails), lhsLifeCycleDetails, rhsLifeCycleDetails)) {
                return false;
            }
        }
        return true;
