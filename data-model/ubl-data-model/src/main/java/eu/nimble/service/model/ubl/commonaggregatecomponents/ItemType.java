 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2}LifeCyclePerformanceAssessmentInput" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ItemType", propOrder = {
    ...
    "lifeCyclePerformanceAssessmentInput"
})
    ...
    implements Serializable, Equals
{
    ...
    @XmlElement(name = "LifeCyclePerformanceAssessmentInput")
    protected LifeCyclePerformanceAssessmentInputType lifeCyclePerformanceAssessmentInput;
    ...
    /**
     * Gets the value of the lifeCyclePerformanceAssessmentInput property.
     * 
     * @return
     *     possible object is
     *     {@link LifeCyclePerformanceAssessmentInputType }
     *     
     */
    @ManyToOne(targetEntity = LifeCyclePerformanceAssessmentInputType.class, cascade = {
        javax.persistence.CascadeType.ALL
    })
    @JoinColumn(name = "LIFE_CYCLE_PERFORMANCE_ASSES_1")
    public LifeCyclePerformanceAssessmentInputType getLifeCyclePerformanceAssessmentInput() {
        return lifeCyclePerformanceAssessmentInput;
    }

    /**
     * Sets the value of the lifeCyclePerformanceAssessmentInput property.
     * 
     * @param value
     *     allowed object is
     *     {@link LifeCyclePerformanceAssessmentInputType }
     *     
     */
    public void setLifeCyclePerformanceAssessmentInput(LifeCyclePerformanceAssessmentInputType value) {
        this.lifeCyclePerformanceAssessmentInput = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            LifeCyclePerformanceAssessmentInputType lhsLifeCyclePerformanceAssessmentInput;
            lhsLifeCyclePerformanceAssessmentInput = this.getLifeCyclePerformanceAssessmentInput();
            LifeCyclePerformanceAssessmentInputType rhsLifeCyclePerformanceAssessmentInput;
            rhsLifeCyclePerformanceAssessmentInput = that.getLifeCyclePerformanceAssessmentInput();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "lifeCyclePerformanceAssessmentInput", lhsLifeCyclePerformanceAssessmentInput), LocatorUtils.property(thatLocator, "lifeCyclePerformanceAssessmentInput", rhsLifeCyclePerformanceAssessmentInput), lhsLifeCyclePerformanceAssessmentInput, rhsLifeCyclePerformanceAssessmentInput)) {
                return false;
            }
        }
        return true;
