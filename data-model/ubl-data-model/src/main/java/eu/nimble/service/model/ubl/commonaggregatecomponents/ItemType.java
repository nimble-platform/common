 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2}LifeCycleCostDetails" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable, Equals
{
    ...
    @XmlElement(name = "LifeCycleCostDetails")
    protected LifeCycleCostDetailsType lifeCycleCostDetails;
    ...
    /**
     * Gets the value of the lifeCycleCostDetails property.
     * 
     * @return
     *     possible object is
     *     {@link LifeCycleCostDetailsType }
     *     
     */
    @ManyToOne(targetEntity = LifeCycleCostDetailsType.class, cascade = {
        javax.persistence.CascadeType.ALL
    })
    @JoinColumn(name = "LIFE_CYCLE_COST_DETAILS_ITEM_0")
    public LifeCycleCostDetailsType getLifeCycleCostDetails() {
        return lifeCycleCostDetails;
    }

    /**
     * Sets the value of the lifeCycleCostDetails property.
     * 
     * @param value
     *     allowed object is
     *     {@link LifeCycleCostDetailsType }
     *     
     */
    public void setLifeCycleCostDetails(LifeCycleCostDetailsType value) {
        this.lifeCycleCostDetails = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            LifeCycleCostDetailsType lhsLifeCycleCostDetails;
            lhsLifeCycleCostDetails = this.getLifeCycleCostDetails();
            LifeCycleCostDetailsType rhsLifeCycleCostDetails;
            rhsLifeCycleCostDetails = that.getLifeCycleCostDetails();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "lifeCycleCostDetails", lhsLifeCycleCostDetails), LocatorUtils.property(thatLocator, "lifeCycleCostDetails", rhsLifeCycleCostDetails), lhsLifeCycleCostDetails, rhsLifeCycleCostDetails)) {
                return false;
            }
        }
        return true;
